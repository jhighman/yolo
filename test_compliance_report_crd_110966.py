#!/usr/bin/env python3
"""
Script to generate a full compliance report for a firm with CRD 110966.
This script is used to investigate an unexpected search failure for FISCHER INVESTMENT GROUP, INC.
"""
...
def main():
    """Generate a full compliance report for firm with CRD 110966."""
    # Create facade
    facade = FirmServicesFacade()
    
    # Search parameters
    subject_id = "test_subject_110966"
    crd_number = "110966"
