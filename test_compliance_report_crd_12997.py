#!/usr/bin/env python3
"""
Script to generate a full compliance report for a firm with CRD 12997.
This script includes additional logging to diagnose search issues.
"""
...
def main():
    """Generate a full compliance report for firm with CRD 12997 with additional diagnostics."""
    # Create facade
    ...
    if firm_details:
        ...
        if report:
            ...
            is_compliant, explanation, alerts = evaluate_registration_status(report)
