#!/usr/bin/env python3
"""
Script to generate a full compliance report for a firm with CRD 131940 (TPG Angelo Gordon).
...
def main():
    """Generate a full compliance report for firm with CRD 131940 (TPG Angelo Gordon)."""
    # Create facade
