#!/usr/bin/env python3
"""
Script to generate a full compliance report for a firm with CRD 47936.
This script tests if our fixes for handling the CRD 47936 response structure work correctly.
"""
...
def main():
    """Generate a full compliance report for firm with CRD 47936 to verify our fixes."""
    # Create facade
    ...
    if firm_details:
        ...
        if report:
            ...
            logger.info("\n✅ SUCCESS: Compliance report generated for CRD 47936")
            logger.info("The fixes for handling the CRD 47936 response structure are working correctly")
        else:
            logger.error("❌ Failed to generate compliance report")
    else:
        logger.error("❌ No firm found with CRD: %s", crd_number)
        logger.error("The fixes for handling the CRD 47936 response structure are not working correctly")
